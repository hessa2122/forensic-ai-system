...
urlpatterns = [
    ...
    path('admin-panel/users/<int:user_id>/revoke/',  views.admin_revoke_user,  name='admin_revoke_user'),
    ...
    # ── API ─────────────────────────────────────────────────────
    path('api/admin/user-stats/', views.api_admin_user_stats, name='api_admin_user_stats'),
]
